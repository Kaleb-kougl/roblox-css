...
import { ScreenContainer, makeScreenContainerProps, ScreenContainerProps } from "../../primitives/ScreenContainer";
...
describe("ScreenContainer primitive", () => {
	const screenContainer = ScreenContainer as unknown as React.FC<ScreenContainerProps> & {
		render: (props: unknown, ref: unknown) => TestElement;
	};
